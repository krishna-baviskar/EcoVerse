                      ...
                      <div className="relative w-48 h-48 mx-auto">
                        <svg className="transform -rotate-90 w-48 h-48">
                          ...
                          <circle
                            ...
                            strokeDashoffset={`${
                              2 * Math.PI * 88 * (1 - (ecoScoreData?.ecoScore || 0) / 100)
                            }`}
                ...
                <div className="p-6 bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-2xl">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-bold">
                      Progress to Level {12 + 1}
                    </h3>
                    <span className="text-2xl font-bold text-purple-400">
                      {Math.round(
                        ((userProfile?.ecoPoints || 0) / 2000) * 100
                      )}
                      %
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-400">
                    <span>
                      {userProfile?.ecoPoints || 0} / 2000 EcoPoints
                    </span>
                    <span>
                      {2000 - (userProfile?.ecoPoints || 0)} points to go!
                    </span>
                  </div>
                </div>
              </>
