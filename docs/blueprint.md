...
- Primary color: Forest green (#388E3C), symbolizing growth and sustainability.
- Background color: Light green (#113312), providing a clean and calming backdrop.
- Accent color: Sky blue (#64B5F6), representing clear skies and clean water, used for interactive elements and highlights.
- Headline font: 'Space Grotesk' sans-serif for headlines; body font: 'Inter' sans-serif for body text, ensuring readability and a modern feel.
- Use flat, outlined icons related to environmental themes (trees, water droplets, charts) for intuitive navigation and visual appeal.
- Subtle animations for EcoScore updates and transitions to provide a smooth and engaging user experience.